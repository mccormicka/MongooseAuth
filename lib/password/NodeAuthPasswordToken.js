...
var model;
exports = module.exports.Model = function NodeAuthPasswordToken(db, options) {
    var _ = require('lodash');
    var log = require('nodelogger')('NodeAuthPasswordToken');
    var bcrypt = require('bcrypt');

    options = _.defaults(options||{}, {tokenExpires:'1m'});

    var TYPE = 'nodeauthpasswordtoken';
    ...
    if (!model) {
        ...
        var schema = db.model('____nodeauthpasswordtoken____', {}).schema;
        schema.add({
