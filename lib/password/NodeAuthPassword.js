...
exports = module.exports = function NodeAuthPassword(schema, options) {

    var log = require('nodelogger')('NodeAuthPassword');
    ...
    schema.plugin(require('./NodeAuthChangePassword'), options);
