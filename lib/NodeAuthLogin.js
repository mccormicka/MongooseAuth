...
exports = module.exports = function NodeAuthLogin(schema, options) {
                ...
                function (req, username, password, next) {
                    ...
                    Model.findOne({ email: username }, function (err, auth) {
                        if (err || !auth) {
                            ...
                            next({message:'api.error.authorized', data:'email.not.confirmed'});
                        }**/
                    });
                }
            ));
    ...
    function unauthorizedResponse() {
        return {message: 'api.error.invalid.params', data: ['email.incorrect', 'password.incorrect']};
    }
};
